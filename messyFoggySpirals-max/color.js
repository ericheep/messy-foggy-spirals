var color = (typeof exports === "undefined")?(function numeric() {}):(exports);
if(typeof global !== "undefined") { global.color = color; }

color.map = function map(value, low1, high1, low2, high2) {
    return low2 + (high2 - low2) * (value - low1) / (high1 - low1);
}

color.tanh = function tanh(x) {
    if( x < -3 ) return -1
...
color.interpolateColors = function interpolateColors(original, target, amount) {
